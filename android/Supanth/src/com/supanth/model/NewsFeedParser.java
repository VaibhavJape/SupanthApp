...
public class NewsFeedParser {
    ...
    private List<RSSFeedItem> rssFeedList;
    private RSSFeedItem rssFeed;
    ...
    public List<RSSFeedItem> parse() {
        try {
            ...
            boolean done = false;
            rssFeed = new RSSFeedItem();
            rssFeedList = new ArrayList<RSSFeedItem>();
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.END_TAG:
                        if (tagName.equals(CHANNEL)) {
                            ...
                            rssFeed = new RSSFeedItem(title, author, link, description, category, pubDate,
                                    guid,
                                    feedburner);
